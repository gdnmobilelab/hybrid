...
public class JSPromiseToPromise<T> {
    public static func pass(_ jsPromise:JSValue) -> Promise<Void> {
...
public extension JSPromiseToPromise where T: AnyObject {
    public static func pass(_ jsPromise:JSValue) -> Promise<T?> {
